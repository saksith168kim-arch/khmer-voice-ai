...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-[#080B14] flex items-center justify-center px-4">
      ...
      <div className="fixed top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-blue-600/8 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white/[0.03] border border-white/[0.08] p-8">
          <div className="mb-7">
            <h1 className="text-2xl font-display text-white">Create your account</h1>
            <p className="text-white/40 text-sm mt-1">Start with 10,000 free characters</p>
          </div>
          <RegisterForm />
